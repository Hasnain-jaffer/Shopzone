...
const AdminPage = () => {
    ...
    // Fetch all users (admin only) — the httpOnly auth cookie is sent
    // automatically by the shared `api` instance (withCredentials: true),
    ...
    // Logout — clears the httpOnly cookie server-side and resets
    // AuthContext's user state; nothing left in localStorage to remove.
    ...
    return (
        <div className="flex h-screen bg-gray-100 overflow-hidden">
            ...
            {/* ── SIDEBAR ── */}
            <div className={`${sidebarOpen ? "w-56" : "w-16"} transition-all duration-300 flex flex-col flex-shrink-0 bg-ink-gradient`}>
