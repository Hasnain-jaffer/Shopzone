          ...
          <div className="hidden md:flex items-center gap-2">
            {user ? (
              <>
                ...
                <button
                  onClick={logout}
                  className="text-sm font-semibold text-gray-600 px-4 py-2 rounded-lg border border-gray-300 hover:border-red-400 hover:text-red-600 hover:bg-red-50 transition-all">
                  Logout
                </button>
              </>
            ) : (
              <>
                <Link to="/login"
                  className="text-sm font-semibold text-gray-600 px-4 py-2 rounded-lg border border-gray-300 hover:border-brand-400 hover:text-brand-600 hover:bg-brand-50 transition-all">
                  Login
                </Link>
                <Link to="/register"
                  className="text-sm font-semibold text-white px-4 py-2 rounded-lg transition-opacity hover:opacity-90 bg-brand-gradient">
                  Register
                </Link>
              </>
            )}
          ...
          {user ? (
            <div className="px-3 pb-2 flex flex-col gap-2">
              ...
              <button
                ...
                className="text-center text-sm font-semibold text-red-600 py-2.5 rounded-lg border border-gray-300">
                Logout
              </button>
            </div>
          ) : (
            <div className="flex gap-3 px-3 pb-2">
              ...
              <Link to="/register" onClick={() => setMenuOpen(false)}
                className="flex-1 text-center text-sm font-semibold text-white py-2.5 rounded-lg bg-brand-gradient">
                Register
              </Link>
            </div>
          )}
